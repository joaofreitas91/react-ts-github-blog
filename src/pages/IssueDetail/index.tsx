...
export function IssueDetail() {
  ...
  return (
    <div className="-m-24 mx-auto flex w-full max-w-3xl flex-col px-3">
      ...
      <article className="prose prose-headings:text-base-title prose-p:text-base-text prose-a:text-base-blue prose-strong:text-base-text prose-li:text-base-text mt-4">
